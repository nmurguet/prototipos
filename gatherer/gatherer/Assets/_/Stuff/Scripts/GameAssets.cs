...
public class GameAssets : MonoBehaviour {
    ...
    public Sprite goldNodeSprite;
    public Sprite treeNodeSprite;

    public Sprite goldNodeDepletedSprite;
    public Sprite treeNodeDepletedSprite;
    
    public Sprite towerConstruction_1;
    public Sprite towerConstruction_2;
    public Sprite towerConstruction_3;
    public Sprite towerConstruction_Built;
